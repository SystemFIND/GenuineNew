...
export default function Footer() {
  return (
    <footer className="bg-[#E6E6E6] text-black mt-10 border-t border-gray-300">
      <div className="max-w-7xl mx-auto px-2 sm:px-4 py-6 flex flex-col gap-4">
        {/* Logo GenuineNews */}
        <div className="flex items-center gap-2">
          <Link href="/">
            <img src="/images/logo2.png" alt="GenuineNews Logo" className="h-8 sm:h-10 w-auto cursor-pointer" />
          </Link>
        </div>
